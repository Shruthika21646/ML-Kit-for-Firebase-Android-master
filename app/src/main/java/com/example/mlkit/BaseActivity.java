...
//		}
		...
		switch (requestCode) {
			case RC_STORAGE_PERMS1:
				if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
					...
					ImageHelper.needPermission(this, requestCode, R.string.confirm_permission);
				}
				break;
			case RC_STORAGE_PERMS2:
				if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
					...
					ImageHelper.needPermission(this, requestCode, R.string.confirm_camera);
				}
				break;
		}
	}
	...
	private void selectPicture() {
		imageFile = ImageHelper.createTempFile(imageFile);
